...
| `dexs/terra-swap-terraluna/index.ts` | [dimension-adapters](https://github.com/DefiLlama/dimension-adapters) | Daily volume and pool fees from `https://swap.openfields.app/api/volume` |
...
- **The name.** DefiLlama already lists TerraSwap, an older and unrelated DEX with its own
  ...
  for example "Terra Swap (terraluna)", and link swap.openfields.app.
