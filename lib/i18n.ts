...
const ko: Dict = {
  ...
  'Blocks, validators, bridges and endpoints, live': '블록, 검증인, 브리지와 엔드포인트, 실시간',
  'Stake LUNA, move it, collect rewards': 'LUNA 스테이킹, 이동, 보상 수령',
  'How the apps on Terra are actually used': '테라 앱들이 실제로 어떻게 쓰이는지',
  'Transactions, addresses and blocks, in plain words': '거래, 주소와 블록을 쉬운 말로',
  'A daily move, a calm minute and five Terra questions': '매일 한 가지 운동, 차분한 1분, 테라 퀴즈 다섯 문제',
  'here': '현재',
  'All apps at openfields.app': 'openfields.app에서 모든 앱 보기',
  'Language': '언어',
  'Connect': '지갑 연결',
...
const es: Dict = {
  ...
  'Openfields apps': 'Apps de Openfields',
  ...
  'Blocks, validators, bridges and endpoints, live': 'Bloques, validadores, puentes y endpoints, en vivo',
  'Stake LUNA, move it, collect rewards': 'Haz staking de LUNA, muévelo, cobra recompensas',
  'How the apps on Terra are actually used': 'Cómo se usan realmente las apps de Terra',
  'Transactions, addresses and blocks, in plain words': 'Transacciones, direcciones y bloques, en palabras claras',
  'A daily move, a calm minute and five Terra questions': 'Un ejercicio al día, un minuto de calma y cinco preguntas sobre Terra',
  'here': 'aquí',
  'All apps at openfields.app': 'Todas las apps en openfields.app',
  'Language': 'Idioma',
  'Connect': 'Conectar',
...
const vi: Dict = {
  ...
  'Openfields apps': 'Ứng dụng Openfields',
  ...
  'Blocks, validators, bridges and endpoints, live': 'Khối, validator, cầu nối và endpoint, theo thời gian thực',
  'Stake LUNA, move it, collect rewards': 'Stake LUNA, chuyển đổi validator, nhận thưởng',
  'How the apps on Terra are actually used': 'Các ứng dụng trên Terra thực sự được dùng ra sao',
  'Transactions, addresses and blocks, in plain words': 'Giao dịch, địa chỉ và khối, bằng lời dễ hiểu',
  'A daily move, a calm minute and five Terra questions': 'Mỗi ngày một bài vận động, một phút tĩnh lặng và năm câu hỏi về Terra',
  'here': 'tại đây',
  'All apps at openfields.app': 'Tất cả ứng dụng tại openfields.app',
  'Language': 'Ngôn ngữ',
  'Connect': 'Kết nối',
