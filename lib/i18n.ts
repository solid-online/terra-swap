...
const ko: Dict = {
  ...
  'Five questions a day about what happened on Terra': '테라에서 일어난 일에 관한 하루 다섯 문제',
  'here': '현재',
...
const es: Dict = {
  ...
  'Five questions a day about what happened on Terra': 'Cinco preguntas al día sobre lo que pasó en Terra',
  'here': 'aquí',
...
const vi: Dict = {
  ...
  'Five questions a day about what happened on Terra': 'Năm câu hỏi mỗi ngày về những gì đã diễn ra trên Terra',
  'here': 'tại đây',
